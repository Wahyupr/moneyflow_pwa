...
import { AlertTriangle, CheckCircle2, Info, Lock, RefreshCw, Sparkles, Zap } from "lucide-react";
      ...
      <section className="mt-4 rounded-xl bg-surface p-4 shadow-card">
        ...
        <div className="mt-3 rounded-lg bg-amber-50 px-3 py-3">
          <p className="text-sm font-semibold text-ink">
            Kuota insight gratis sudah terpakai.
          </p>
...
function ReadyInsight({
  ...
  return (
    <section className="mt-4 rounded-xl bg-surface p-4 shadow-card">
      <Header sealed generatedAt={generatedAt} />
...
function Header({ sealed, generatedAt }: { sealed: boolean; generatedAt?: string }) {
  return (
